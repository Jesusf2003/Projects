...
public class DisqueraDAOimpl implements DisqueraDAO {
	...
	public Disquera consultarByDescripcionJPQL(String descripcion) {
		...
		TypedQuery<Disquera> queryDisquera = (TypedQuery<Disquera>) em.createQuery("FROM Disquera WHERE DESDIS = :desc ");
	...
	public Disquera consultarByDescripcionNative(String descripcion) {
		...
		TypedQuery<Disquera> queryDisquera = (TypedQuery<Disquera>) em.createNativeQuery("SELECT * FROM Disquera WHERE DESDIS = ?", Disquera.class);
		
		queryDisquera.setParameter(4, descripcion);
